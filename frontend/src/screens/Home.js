...
export default function Home() {
  ...
  useEffect(() => {
    ...
    fetch('http://192.168.1.241:5000/products/categories', {
      method: 'GET', 
      headers: {
   ...
   useEffect(() => {
    fetch('http://192.168.1.241:5000/products', {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      },
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.flashDealsContainer}>
        ...
        <View style={styles.flashDealsSvgContainer}>
          <Svg width="150%" height="100%" style={styles.flashDealsSvg}>
            <Defs>
      ...
      <View style={styles.productList}>
        ...
        {products.map((product, index) => (
          <View
            ...
            style={[
              styles.productItem,
              // Thêm paddingLeft cho cột lẻ và paddingRight cho cột chẵn
...
marginTop:20,
  ...
  flashDealsHeader: {
    ...
    paddingHorizontal: 10,
    height: 30,
    zIndex: 1, // Đảm bảo header nằm trên SVG
  },
  flashDealsTitle: {
    flexDirection: 'row',
    gap: 10,
