...
export default function AddAddress({ navigation, route }) {
  ...
  const handleAddAddress = async () => {
    ...
    setLoading(true);
    if (user_id === "no_user") {
      const isSuccess = await addAddressNoUser(newAddress);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.formContainer}>
        <Input
          ...
          onChangeText={(text) =>
            setNewAddress({ ...newAddress, loca_per_name: text })
          }
          style={styles.input}
        ...
        <Input
          ...
          onChangeText={(text) =>
            setNewAddress({ ...newAddress, loca_phone: text })
          }
          style={styles.input}
        ...
        <View style={styles.inputAddress}>
          <Picker
            ...
            onValueChange={(value) =>
              setNewAddress({ ...newAddress, loca_address_commue: value })
            }
            style={[
              styles.picker,
        ...
        <Input
          ...
          onChangeText={(text) =>
            setNewAddress({ ...newAddress, loca_address_detail: text })
          }
          style={styles.input}
